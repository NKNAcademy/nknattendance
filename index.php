...
<body class="bg-gradient-login" style="background-image: url('img/logo/loral1.jpe00g');">
                            ...
                            <div class="col-lg-12">
                                <div class="login-form">
                                    ...
                                    <form class="user" method="Post" action="">
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="passwordd" required class="form-control" id="exampleInputPassword" placeholder="Enter Password">
                                        </div>
                                        <div class="form-group">
  ...
  if(isset($_POST['login'])){
    ...
    if($userType == "Administrator"){
      ...
      $query = "SELECT * FROM tbladmin WHERE emailAddress = '$username' AND passwordd = '$password'";
      $rs = $conn->query($query);
      $num = $rs->num_rows;
      $rows = $rs->fetch_assoc();
      ...
      $query = "SELECT * FROM tblclassteacher WHERE emailAddress = '$username' AND passwordd = '$password'";
      $rs = $conn->query($query);
      $num = $rs->num_rows;
      $rows = $rs->fetch_assoc();
