 ...
 <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center bg-gradient-primary justify-content-center" href="index.php">
        <div class="sidebar-brand-icon" >
          <img src="img/new logo initial version/NKN.png">
        </div>
        <div class="sidebar-brand-text mx-3">NKN Academy AMS</div>
      </a>
      <hr class="sidebar-divider my-0">
      <li class="nav-item active">
        <a class="nav-link" href="index.php">
        <img src="img/new logo initial version/dashboard.png" width="20px">
      ...
      <div class="sidebar-heading">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap2"
          ...
          <img src="img/new logo initial version/students.png" width="20px">
      ...
      Attendance
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrapcon"
         ...
         <img src="img/new logo initial version/data settings.png" width="20px">
