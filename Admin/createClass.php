...
<body id="page-top">
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            ...
                            echo"
                              <tr>
                                ...
                                <td><a href='#' onclick='openDeletePopup(\"{$rows['className']}\", \"{$rows['Id']}\")'><img src='img/new logo initial version/delete.png' style='width:20px; padding-top:5px;'></a></td>
                              </tr>";
                          }
                      }
                      else
  ...
  <!-- Scroll to top -->
  <a class="scroll-to-top rounded" href="#page-top" style="padding-top:7px;">
