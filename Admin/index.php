...
INNER JOIN tblteacherclassarms ON tblteacherclassarms.teacherId = tblclassteacher.Id
INNER JOIN tblclassarms ON tblclassarms.Id = tblteacherclassarms.classArmId
...
if (mysqli_num_rows($result) > 0) {
    ...
    $queryy = "SELECT tblclass.className,tblclassarms.classArmName 
    FROM tblclassteacher
    INNER JOIN tblclass ON tblclass.Id = tblclassteacher.classId
...
?>
  ...
  <a class="scroll-to-top rounded" href="#page-top">
    <img src="img/new logo initial version/Up.png" width="20px">
  </a>
