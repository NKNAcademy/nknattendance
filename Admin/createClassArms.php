...
<body id="page-top">
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            ...
                            echo"
                              <tr>
                                ...
                                <td><a href='#'  onclick='openDeletePopup(\"{$rows['classArmName']}\",\"{$rows['Id']}\")'><img src='img/new logo initial version/delete.png' style='width:20px; padding-top:5px;'></a></td>
                              </tr>";
                          }
                      }
                      else
  ...
  <!-- Scroll to top -->
  <a class="scroll-to-top rounded" href="#page-top" style="padding-top:0px;">
...
<div id='deleteConfirmationPopup' class='popup-overlay' style='display:none'>
        <div class='popup'>
            ...
            <div class='popup-body'>
                <text>Are you sure you would like to delete the class <b id="itemType"></b>?<br> The action cannot be undone. </text>
            </div>
